...
## deploy from local to azure
https://learn.microsoft.com/en-us/azure/azure-functions/functions-develop-vs-code?tabs=csharp#application-settings-in-azure 
- environment variables defined in the local.settings.json will be used in azure
- requirement.txt 
- sync the local setting to azure 